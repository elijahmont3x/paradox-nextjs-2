...
import { Copy, Info, Check, PieChart as PieChartIcon, ExternalLink, Lock, FileText, CheckCircle, Users, BarChartHorizontal, MinusCircle, Target, Gift, GitCommitVertical, Droplets, Megaphone } from "lucide-react"; // Enhanced icons
